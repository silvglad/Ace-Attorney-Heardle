var app = (function () {
        ...
        m.$on("click", e[4]),
        {
          c() {
            (t = w("header")),
              ...
              (l = x()),
              (u = w("h1")),
              (u.textContent = "Ace Attorney Heardle"),
              (c = x()),
              (d = w("div")),
              Q(h.$$.fragment),
              (f = x()),
    ...
    function Nt(t) {
      ...
      return {
        c() {
          (n = w("div")),
            (n.innerHTML =
              '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a>, and <a href="https://heardle-kpop.glitch.me/" title="Heardle">K-Pop Heardle</a> but for Ace Attorney songs. Each Ace Attorney Heardle is randomly chosen from Ace Attorney\'s OSTs.</p> \n\n\n\n <p class="mb-3">@susatoss on twitter! </p> \n\n\n\n <p class="mb-3">If the correct answer doesn\'t appear in the suggestion list, please try to refresh the page and its cache! </p> \n\n\n\n <p class="mb-3">Want to make your own Heardle? Check out the <a href="https://glitch.com/edit/#!/revue-starlight-heardle?path=README.md">README</a>  </p>  \n\n\n\n <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">Soundcloud</a>,\n    <a href="https://svelte.dev">Svelte</a>,\n    <a href="https://tailwindcss.com">Tailwind</a>,\n    <a href="https://fonts.google.com/noto/specimen/Noto+Serif+Display">Noto Serif Display</a>, <a href="https://fonts.google.com/noto/specimen/Noto+Sans">Noto Sans</a>,\n    <a href="https://iconsvg.xyz">IconSVG</a>, <a href="https://momentjs.com">momentjs</a>,\n    <a href="https://tarekraafat.github.io/autoComplete.js/#/">autocomplete.js</a>, and powered by <a href="https://glitch.com/">Glitch</a>. <a href="https://omakase.studio" title="Studio Omakase">Served omakase / お任せ</a>. '),
            M(n, "class", "text");
        },
        m(e, t) {
          g(e, n, t);
        ...
        (u = new Bt({})),
        {
          c() {
            (n = w("p")),
              (s = w("p")),
              (n.textContent =
                "Ace Attorney Heardle isn't getting updated anymore, sorry!"),
              (r = x()),
              (s = w("p")),
              // (s.innerHTML =
        ...
        (O = new Rt({})),
        {
          c() {
            ...
            (o = x()),
              ...
              (m = w("div")),
              (k = w("div")),
              (k.textContent = "Next Ace Attorney song in:"),
              (b = x()),
              Q(S.$$.fragment),
              (D = x()),
              (T = w("div")),
    ...
    function an(e) {
      ...
      return {
        c() {
          (t = _("You got today's Ace Attorney Heardle within the first ")),
            (n = _(s)),
            (r = _(" seconds."));
        },
        m(e, s) {
    ...
    function ln(e) {
      ...
      return {
        c() {
          (t = _("You got today's Ace Attorney Heardle within ")),
            (n = _(o)),
            (r = _("\n                second")),
            (s = _(a)),
            (i = _("."));
    ...
    function un(t) {
      ...
      return {
        c() {
          n = _(
            "You didn't get today's Ace Attorney Heardle. Better luck tomorrow! 💎"
          );
        },
        m(e, t) {
          g(e, n, t);
      ...
      return (
        ...
        [
          ...
          () => {
            ...
            let e = "Ace Attorney Heardle #" + (s.id + 1),
              t = "";
            let hhh =
              "Put your skills to the test at https://aceattorney-heardle.glitch.me";
            a
    ...
    const Cn = ue([
        ...
        "The Great Ace Attorney 2 - Partners ~ The Game Is Afoot!",
        "Gyakuten Kenji 2 - The Man Who Masterminds The Game",
        "Phoenix Wright: Justice for All - Investigation ~ Core 2002",
        "Miles Edgeworth: Ace Attorney Investigations - Confrontation ~ Presto 2009",
        "Apollo Justice: Ace Attorney - Reminiscence ~ Forgotten Legend",
        "The Great Ace Attorney - Investigation ~ Core 2015",
        "Phoenix Wright: Ace Attorney - Questioning ~ Allegro 2001",
        "Miles Edgeworth: Ace Attorney Investigations - Confess The Truth 2009",
        "Professor Layton Vs Phoenix Wright ~ Objection! 2012",
        "Phoenix Wright: Spirit of Justice - Reminiscence ~ Inherited Hopes",
        "The Great Ace Attorney: Adventures - Kazuma Asogi ~ Nocturne",
        "The Great Ace Attorney: Adventures - Susato Mikotoba ~ Serenade",
        "Miles Edgeworth: Ace Attorney Investigations - Kay Faraday ~ The Great Truth Burglar",
        "Apollo Justice: Ace Attorney - Won the Case! ~ Our Victory",
        "Phoenix Wright: Trials and Tribulations - Reminiscence ~ The Bitter Taste of Truth",
        "Professor Layton vs. Phoenix Wright: Ace Attorney - Won the Case! ~ First Victory (English Court)",
        "Phoenix Wright: Dual Destinies - Reminiscence ~ Wandering Heart",
        "Phoenix Wright: Dual Destinies - Dual Destinies ~ End",
        "Apollo Justice: Ace Attorney - Pursuit ~ Overtaken",
        "The Great Ace Attorney 2 - Prelude to the Blossoming Attorney",
        "The Great Ace Attorney 2 - Ryutaro Naruhodo ~ Objection! 2017",
        "Gyakuten Kenji 2 - Raymond Shields ~ Joking Motive",
        "Phoenix Wright: Dual Destinies - Chains of the Heart ~ Psyche-Lock 2013",
        "Apollo Justice: Ace Attorney - Klavier Gavin ~ Guilty Love",
        "Phoenix Wright: Ace Attorney - The Blue Badger ~ I Want To Protect You",
        "Phoenix Wright: Trials and Tribulations - Godot ~ The Fragrance of Dark Coffee",
        "Miles Edgeworth: Ace Attorney Investigations - Dick Gumshoe ~ I can do it when it counts, pal!",
        "Gyakuten Kenji 2 - Sebastian Debeste ~ Ichiryuu's Farewell",
        "Phoenix Wright: Spirit of Justice - The Court of Resignation",
        "Phoenix Wright: Dual Destinies - Mood Matrix ~ Commence The Psychological Analysis!",
        "The Great Ace Attorney: Adventures - Herlock Sholmes ~ Great Detective of the Foggy Town",
        "Phoenix Wright: Spirit of Justice - Ema Skye ~ Scientific Detective 2016",
        "Phoenix Wright: Trials and Tribulations - Trials and Tribulations ~ Court Begins",
        "Professor Layton vs. Phoenix Wright: Ace Attorney - Pursuit ~ Casting Magic / Spell Breaker",
        "The Great Ace Attorney 2: Resolve - The Great Secret Trial ~ Court Begins",
        "Phoenix Wright: Dual Destinies - Trucy’s Theme ~ Child of Magic 2013",
        "Phoenix Wright: Ace Attorney - Pursuit ~ Cornered",
        "The Great Ace Attorney - Great Cross-Examination ~ Allegro",
        "Phoenix Wright: Trials and Tribulations - Pursuit ~ Caught (Hard Rock Remix ~ Trailer version)",
        "The Great Ace Attorney - Barok van Zieks ~ The Reaper of the Bailey",
        "Phoenix Wright: Ace Attorney - Reminiscence ~ DL-6 Incident",
        "Phoenix Wright: Justice for All - Reminiscence ~ Steel Samurai's Ballad",
        "The Great Ace Attorney - Gina Lestrade ~ A Blast from the East End",
        "Gyakuten Kenji 2 - Reminiscence ~ The Girl's Lost Memories",
        "The Great Ace Attorney - Tobias Gregson ~ The Great Detective's Great Foe",
        "The Great Ace Attorney - Susato Mikotoba ~ Flower Blooming in the New World",
        "Gyakuten Kenji 2 - Pursuit ~ Wanting to Find the Truth",
        "Phoenix Wright: Ace Attorney - Phoenix Wright ~ Objection! 2001",
        "Ace Attorney: Spirit of Justice - Athena Cykes ~ Courtroom Revolutionnaire 2016",
        "The Great Ace Attorney - Pursuit ~ The Great Turnabout",
        "Ace Attorney: Dual Destinies - Apollo Justice ~ I'm Fine!",
        "Phoenix Wright: Ace Attorney - Maya Fey ~ Turnabout Sisters 2001",
        "Miles Edgeworth: Ace Attorney Investigations - Pursuit ~ Lying Coldly",
        "Phoenix Wright: Justice for All - Great Revival ~ Franziska Von Karma",
        "Phoenix Wright: Trials and Tribulations - Objection! 2004",
        "Miles Edgeworth: Ace Attorney Investigations - Tyrell Badd ~ The Truth Isn't Sweet",
        "Phoenix Wright: Justice for All - Great Revival ~ Miles Edgeworth",
        "Gyakuten Kenji 2 - Sebastian Debeste ~ First Class Reasoning",
        "Phoenix Wright: Ace Attorney - Damon Gant ~ Swimming, Anyone",
        "Phoenix Wright: Spirit of Justice - Divination Seance ~ Last Sights",
        "Apollo Justice: Ace Attorney - Perceive ~ Surging Eyes",
        "Phoenix Wright: Spirit of Justice - Phoenix Wright ~ Objection! 2016",
        "",
  
        "Phoenix Wright: Ace Attorney Trials and Tribulations - Mask☆deMasque ~ Pleeeeease Listen!",
        "Phoenix Wright: Ace Attorney Trials and Tribulations - Luke Atmey ~ I Just Want Love",
        "Phoenix Wright: Ace Attorney Trials and Tribulations - Dahlia Hawthorne ~ Distant Traces Of Beauty",
        "Phoenix Wright: Ace Attorney Trials and Tribulations - Questioning ~ Moderato 2004",
        "Phoenix Wright: Ace Attorney Trials and Tribulations - Reminiscence ~ The Scenery Seen From Dusky Bridge",
        "Phoenix Wright: Ace Attorney - Dick Gumshoe ~ Detective Gumshoe, Pal",
        "Phoenix Wright: Ace Attorney - Happy People",
        "Phoenix Wright: Ace Attorney - Jake Marshall ~ The Detective From The Wild West",
        "Phoenix Wright: Ace Attorney - The Steel Samurai",
        "Phoenix Wright: Ace Attorney - Telling The Truth 2001",
        "Phoenix Wright: Justice for All - Hotline Of Fate  ",
        "Phoenix Wright: Justice for All - Pearl Fey ~ Pearly Questioning",
        "Phoenix Wright: Justice for All - Shelly De Killer ~ A Murderous Gentlemans Pleasure",
        "Phoenix Wright: Justice for All - Trick And Magic",
        "Phoenix Wright: Justice for All - Courtroom Lobby ~ Another Overture",
  
        "Apollo Justice: Ace Attorney - Cross-Examination ~ Allegro",
        "Apollo Justice: Ace Attorney - Drew Studio",
        "Apollo Justice: Ace Attorney - Ema Skye ~ The Scientific Detective",
        "Apollo Justice: Ace Attorney - Investigation ~ Opening 2007",
        "Apollo Justice: Ace Attorney - Prologue",
        "Apollo Justice: Ace Attorney - Thrill Theme - Suspense",
        "Apollo Justice: Ace Attorney - Apollo Justice ~ A New Trial Is In Session! (Objection 2007)",
        "Apollo Justice: Ace Attorney - Lamiroir ~ Landscape Painter In Sound",
        "Apollo Justice: Ace Attorney - Trucy's Theme ~ Child Of Magic",
        "Apollo Justice: Ace Attorney - Investigation ~ Core 2007",
        "Apollo Justice: Ace Attorney - Court Begins",
  
        "Miles Edgeworth: Ace Attorney Investigations - Confrontation ~ Moderato 2009",
        "Miles Edgeworth: Ace Attorney Investigations - Court Guardians Of The Law",
        "Miles Edgeworth: Ace Attorney Investigations - Crises Of Fate",
        "Miles Edgeworth: Ace Attorney Investigations - Investigation ~ Middlegame 2009",
        "Miles Edgeworth: Ace Attorney Investigations - Miles Edgeworth ~ Objection! 2009",
        "Miles Edgeworth: Ace Attorney Investigations - Quercus Alba ~ The Enemy Who Surpasses The Law",
        "Miles Edgeworth: Ace Attorney Investigations - Reminiscence ~ KG-8 Case",
        "Miles Edgeworth: Ace Attorney Investigations - Shi-Long Lang ~ Speak Up, Pup!",
        "Miles Edgeworth: Ace Attorney Investigations - Tricks And Gimmicks",
        "Miles Edgeworth: Ace Attorney Investigations - Reminiscence ~ False Relations",
  
        "Gyakuten Kenji 2 - Bonds ~ A Heart That Believes",
        "Gyakuten Kenji 2 - Confess the Truth ~ 2011",
        "Gyakuten Kenji 2 - Confrontation ~ Allegro 2011",
        "Gyakuten Kenji 2 - Confrontation ~ Presto 2011",
        "Gyakuten Kenji 2 - Justine Courtney ~ Goddess of Law",
        "Gyakuten Kenji 2 - Investigation ~ Opening 2011",
        "Gyakuten Kenji 2 - Logic Chess ~ Opening",
        "Gyakuten Kenji 2 - Objection! 2011",
        "Gyakuten Kenji 2 - Reminiscence ~ IS-7 Incident",
        "Gyakuten Kenji 2 - Reminiscence ~ The Fall of the House of Lang",
  
        "Phoenix Wright: Dual Destinies - Athena Cykes - Let's Do This!",
        "Phoenix Wright: Dual Destinies - Apollo Justice - Start of a New Trial 2013",
        "Phoenix Wright: Dual Destinies - Difficult People",
        "Phoenix Wright: Dual Destinies - Athena Cykes - Courtroom Révolutionnaire",
        "Phoenix Wright: Dual Destinies - Pearl Fey - With Pearly 2013",
        "Phoenix Wright: Dual Destinies - Won the Case! - Everyone's Victory",
        "Phoenix Wright: Dual Destinies - Phoenix Wright ~ Objection! 2013",
        "Phoenix Wright: Dual Destinies - Courtroom Lounge ~ Prelude of Tomorrow",
        "Phoenix Wright: Dual Destinies - Simon Blackquill ~ Twisted Swordsmanship",
        "Phoenix Wright: Dual Destinies - The Dark Age Of Law",
        "Phoenix Wright: Dual Destinies - Pursuit ~ Keep Pressing On!",
        "Phoenix Wright: Dual Destinies - Miles Edgeworth ~ Great Revival 2013",
        "Phoenix Wright: Dual Destinies - Announce the Truth ~ 2013",
      ]),
      On = {
        subscribe: ue(
          [
            {
              url: "https://soundcloud.com/emmetrm/dgs1-mikotoba-susato-the-blooming-flower-of-the-new-world",
              answer:
                "The Great Ace Attorney - Susato Mikotoba ~ Flower Blooming in the New World",
            },
            {
              url: "https://soundcloud.com/ichoilva/gyakuten-kenji-2-ost-24-pursuit-wanting-to-find-the-truth",
              answer: "Gyakuten Kenji 2 - Pursuit ~ Wanting to Find the Truth",
            },
            {
              url: "https://soundcloud.com/milulumilu/phoenix-wright-ace-attorney-6",
              answer:
                "Phoenix Wright: Ace Attorney - Phoenix Wright ~ Objection! 2001",
            },
            {
              url: "https://soundcloud.com/drusionry/ace-attorney-6-ost-athena-cykes-courtroom-revolutionnaire-2016",
              answer:
                "Ace Attorney: Spirit of Justice - Athena Cykes ~ Courtroom Revolutionnaire 2016",
            },
            {
              url: "https://soundcloud.com/emmetrm/dgs1-pursuit?in=emmetrm/sets/dai-gyakuten-saiban",
              answer: "The Great Ace Attorney - Pursuit ~ The Great Turnabout",
            },
            {
              url: "https://soundcloud.com/jorgecabrera-1/apollo-justice-im-fine",
              answer: "Ace Attorney: Dual Destinies - Apollo Justice ~ I'm Fine!",
            },
            {
            ...
            {
              url: "https://soundcloud.com/user485151016/lying-coldly-ace-attorney",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Pursuit ~ Lying Coldly",
            },
            {
              url: "https://soundcloud.com/user-123156866/partners-the-game-is-afoot-dai-gyakuten-saiban-2",
              answer: "The Great Ace Attorney 2 - Partners ~ The Game Is Afoot!",
            },
            {
              url: "https://soundcloud.com/user-308844814/the-man-who-masterminds-the",
              answer: "Gyakuten Kenji 2 - The Man Who Masterminds The Game",
            },
            {
              url: "https://soundcloud.com/jewbbq1942/phoenix-wright-ace-attorney-justice-for-all-ost-investigation-core-2002",
              answer:
                "Phoenix Wright: Justice for All - Investigation ~ Core 2002",
            },
            {
              url: "https://soundcloud.com/user-937823181/confrontation-presto-2009",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Confrontation ~ Presto 2009",
            },
            {
              url: "https://soundcloud.com/user-583594756/reminiscing-forgotten-legend",
              answer:
                "Apollo Justice: Ace Attorney - Reminiscence ~ Forgotten Legend",
            },
            {
              url: "https://soundcloud.com/manuel-rm-978146924/investigation-core-2015",
              answer: "The Great Ace Attorney - Investigation ~ Core 2015",
            },
            {
              url: "https://soundcloud.com/user-338850232/questioning-allegro-2001",
              answer: "Phoenix Wright: Ace Attorney - Questioning ~ Allegro 2001",
            },
            {
              url: "https://soundcloud.com/user203073987/confess-the-truth-ace-attorney",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Confess The Truth 2009",
            },
            {
              url: "https://soundcloud.com/cutestlesbian/professor-layton-vs-phoenix-wright-objection-2012",
              answer: "Professor Layton Vs Phoenix Wright ~ Objection! 2012",
            },
            {
              url: "https://soundcloud.com/ace-attorney-fanmade-predictions/reminiscing-inherited-hopes",
              answer:
                "Phoenix Wright: Spirit of Justice - Reminiscence ~ Inherited Hopes",
            },
            {
              url: "https://soundcloud.com/emmetrm/dgs1-kazuma-asougi-nocturne",
              answer:
                "The Great Ace Attorney: Adventures - Kazuma Asogi ~ Nocturne",
            },
            {
              url: "https://soundcloud.com/emmetrm/dgs1-susato-mikotoba-serenade",
              answer:
                "The Great Ace Attorney: Adventures - Susato Mikotoba ~ Serenade",
            },
            {
              url: "https://soundcloud.com/lelpinguin42/ace-attorney-investigations-miles-edgeworth-kay-faraday-the-great-truth-burglar",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Kay Faraday ~ The Great Truth Burglar",
            },
            {
              url: "https://soundcloud.com/user-583594756/won-the-case-our-victory",
              answer:
                "Apollo Justice: Ace Attorney - Won the Case! ~ Our Victory",
            },
            {
              url: "https://soundcloud.com/user-338850232/recollection-the-bitter-taste",
              answer:
                "Phoenix Wright: Trials and Tribulations - Reminiscence ~ The Bitter Taste of Truth",
            },
            {
              url: "https://soundcloud.com/edu-gamb-n/won-the-case-first-victory-english-turnabout-mix",
              answer:
                "Professor Layton vs. Phoenix Wright: Ace Attorney - Won the Case! ~ First Victory (English Court)",
            },
            {
              url: "https://soundcloud.com/rob-shenton-1/dual-destinies-reminiscence",
              answer:
                "Phoenix Wright: Dual Destinies - Reminiscence ~ Wandering Heart",
            },
            {
              url: "https://soundcloud.com/user-32653759/phoenix-wright-ace-attorney",
              answer: "Phoenix Wright: Dual Destinies - Dual Destinies ~ End",
            },
            {
              url: "https://soundcloud.com/user-583594756/pressing-pursuit-overtaken",
              answer: "Apollo Justice: Ace Attorney - Pursuit ~ Overtaken",
            },
            {
              url: "https://soundcloud.com/daigyak2/dgs2-not-susato",
              answer:
                "The Great Ace Attorney 2 - Prelude to the Blossoming Attorney",
            },
            {
              url: "https://soundcloud.com/enjihesian/ryutaro-naruhodo-objection-dai-gyakuten-saiban-2",
              answer:
                "The Great Ace Attorney 2 - Ryutaro Naruhodo ~ Objection! 2017",
            },
            {
              url: "https://soundcloud.com/jorgecabrera-1/12-raymond-shields-joking",
              answer: "Gyakuten Kenji 2 - Raymond Shields ~ Joking Motive",
            },
            {
              url: "https://soundcloud.com/the-legend-of-link-270966626/phoenix-wright-dual-destinies",
              answer:
                "Phoenix Wright: Dual Destinies - Chains of the Heart ~ Psyche-Lock 2013",
            },
            {
              url: "https://soundcloud.com/moogle-knights-6-bide-inc/air-guitar",
              answer:
                "Apollo Justice: Ace Attorney - Klavier Gavin ~ Guilty Love",
            },
            {
            ...
            {
              url: "https://soundcloud.com/lelpinguin42/ace-attorney-investigations-miles-edgeworth-dick-gumshoe-i-can-do-it-when-it-counts-pal",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Dick Gumshoe ~ I can do it when it counts, pal!",
            },
            {
              url: "https://soundcloud.com/user-308844814/yumihiko-ichiyanagi-1?in=user-308844814/sets/ace-attorney-investigations-2-ost",
              answer:
                "Gyakuten Kenji 2 - Sebastian Debeste ~ Ichiryuu's Farewell",
            },
            {
              url: "https://soundcloud.com/ace-attorney-fanmade-predictions/the-court-of-resignation",
              answer:
                "Phoenix Wright: Spirit of Justice - The Court of Resignation",
            },
            {
              url: "https://soundcloud.com/jello-apocalypse/dual-destinies-ost-37-mood-matrix-commence-the-psychological-analysis",
              answer:
                "Phoenix Wright: Dual Destinies - Mood Matrix ~ Commence The Psychological Analysis!",
            },
            {
              url: "https://soundcloud.com/alex-h-18978524/sherlock-holmes-the-great",
              answer:
                "The Great Ace Attorney: Adventures - Herlock Sholmes ~ Great Detective of the Foggy Town",
            },
            {
              url: "https://soundcloud.com/ace-attorney-fanmade-predictions/ema-skye-scientific-detective-2016",
              answer:
                "Phoenix Wright: Spirit of Justice - Ema Skye ~ Scientific Detective 2016",
            },
            {
              url: "https://soundcloud.com/user-338850232/trial-2?in=user-338850232/sets/phoenix-wright-ace-attorney-trials-and-tribulations-ost",
              answer:
                "Phoenix Wright: Trials and Tribulations - Trials and Tribulations ~ Court Begins",
            },
            {
              url: "https://soundcloud.com/roll20musics/spell-breaker-cornered-professor-layton-vs-ace-attorney",
              answer:
                "Professor Layton vs. Phoenix Wright: Ace Attorney - Pursuit ~ Casting Magic / Spell Breaker",
            },
            {
              url: "https://soundcloud.com/daigyak2/dgs2-kaitei3",
              answer:
                "The Great Ace Attorney 2: Resolve - The Great Secret Trial ~ Court Begins",
            },
            {
              url: "https://soundcloud.com/emilygwt/trucys-theme-child-of-magic",
              answer:
                "Phoenix Wright: Dual Destinies - Trucy’s Theme ~ Child of Magic 2013",
            },
            {
              url: "https://soundcloud.com/user-338850232/pursuit-cornered",
              answer: "Phoenix Wright: Ace Attorney - Pursuit ~ Cornered",
            },
            {
              url: "https://soundcloud.com/user-503201551/great-cross-examination?in=user-503201551/sets/the-great-ace-attorney-adventures-dai-gyakuten-saiban-full-ost",
              answer:
                "The Great Ace Attorney - Great Cross-Examination ~ Allegro",
            },
            {
              url: "https://soundcloud.com/samuele-concas-496708202/phoenix-wright-tt-pursuit-caught-remix",
              answer:
                "Phoenix Wright: Trials and Tribulations - Pursuit ~ Caught (Hard Rock Remix ~ Trailer version)",
            },
            {
              url: "https://soundcloud.com/user-503201551/barok-van-zieks-the-reaper-of?in=user-503201551/sets/the-great-ace-attorney-adventures-dai-gyakuten-saiban-full-ost",
              answer:
                "The Great Ace Attorney - Barok van Zieks ~ The Reaper of the Bailey",
            },
            {
            ...
            {
              url: "https://soundcloud.com/user-338850232/recollection-steel-samurais",
              answer:
                "Phoenix Wright: Justice for All - Reminiscence ~ Steel Samurai's Ballad",
            },
            {
              url: "https://soundcloud.com/user-503201551/gina-lestrade-a-blast-from-the?in=user-503201551/sets/the-great-ace-attorney-adventures-dai-gyakuten-saiban-full-ost",
              answer:
                "The Great Ace Attorney - Gina Lestrade ~ A Blast from the East End",
            },
            {
              url: "https://soundcloud.com/user-308844814/reminiscence-the-girls-lost",
              answer:
                "Gyakuten Kenji 2 - Reminiscence ~ The Girl's Lost Memories",
            },
            {
              url: "https://soundcloud.com/user-503201551/tobias-gregson-the-great?in=user-503201551/sets/the-great-ace-attorney-adventures-dai-gyakuten-saiban-full-ost",
              answer:
                "The Great Ace Attorney - Tobias Gregson ~ The Great Detective's Great Foe",
            },
            {
            ...
            {
              url: "https://soundcloud.com/user-338850232/great-revival-franziska-von?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
              answer:
                "Phoenix Wright: Justice for All - Great Revival ~ Franziska Von Karma",
            },
            {
              url: "https://soundcloud.com/cutestlesbian/phoenix-wright-ace-attorney-trials-and-tribulations-objection-2004?utm_source=mobi&utm_campaign=social_sharing",
              answer: "Phoenix Wright: Trials and Tribulations - Objection! 2004",
            },
            {
              url: "https://soundcloud.com/everything_ace_attorney/ace-attorney-investigations-2?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Tyrell Badd ~ The Truth Isn't Sweet",
            },
            {
              url: "https://soundcloud.com/user-338850232/great-revival-miles-edgeworth?utm_source=mobi&utm_campaign=social_sharing",
              answer:
                "Phoenix Wright: Justice for All - Great Revival ~ Miles Edgeworth",
            },
            {
              url: "https://soundcloud.com/jonah-j-438855170/ace-attorney-investigations-prosecutors-path-ost-sebastian-debeste-first-class-reasoning?utm_source=mobi&utm_campaign=social_sharing",
              answer:
                "Gyakuten Kenji 2 - Sebastian Debeste ~ First Class Reasoning",
            },
            {
              url: "https://soundcloud.com/user-338850232/damon-gant-swimming-anyone?utm_source=mobi&utm_campaign=social_sharing",
              answer:
                "Phoenix Wright: Ace Attorney - Damon Gant ~ Swimming, Anyone",
            },
            {
              url: "https://soundcloud.com/rides1283man/divination-seance-last-sights?utm_source=mobi&utm_campaign=social_sharing",
              answer:
                "Phoenix Wright: Spirit of Justice - Divination Seance ~ Last Sights",
            },
            {
              url: "https://soundcloud.com/user279492948/percieve-surging-eyes?utm_source=mobi&utm_campaign=social_sharing",
              answer: "Apollo Justice: Ace Attorney - Perceive ~ Surging Eyes",
            },
            {
              url: "https://soundcloud.com/ace-attorney-fanmade-predictions/phoenix-wright-objection-2016?utm_source=mobi&utm_campaign=social_sharing",
              answer:
                "Phoenix Wright: Spirit of Justice - Phoenix Wright ~ Objection! 2016",
            },
            {
              url: "https://soundcloud.com/valentin-cyprien/phoenix-wright-ace-attorney-soundtrack-dual-destinies-pursuit-keep-pressing-on?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
              answer:
                "Phoenix Wright: Dual Destinies - Pursuit ~ Keep Pressing On!",
            },
            ...
            {
              url: "https://soundcloud.com/user-338850232/mask-demasque-pleeeeease?in=user-338850232/sets/phoenix-wright-ace-attorney-trials-and-tribulations-ost",
              answer:
                "Phoenix Wright: Ace Attorney Trials and Tribulations - Mask☆deMasque ~ Pleeeeease Listen!",
            },
            {
              url: "https://soundcloud.com/user-338850232/luke-atmey-i-just-want-love?in=user-338850232/sets/phoenix-wright-ace-attorney-trials-and-tribulations-ost",
              answer:
                "Phoenix Wright: Ace Attorney Trials and Tribulations - Luke Atmey ~ I Just Want Love",
            },
            {
              url: "https://soundcloud.com/user-338850232/dahlia-hawthorne-distant?in=user-338850232/sets/phoenix-wright-ace-attorney-trials-and-tribulations-ost",
              answer:
                "Phoenix Wright: Ace Attorney Trials and Tribulations - Dahlia Hawthorne ~ Distant Traces Of Beauty",
            },
            {
              url: "https://soundcloud.com/user-338850232/questioning-moderato-2004?in=user-338850232/sets/phoenix-wright-ace-attorney-trials-and-tribulations-ost",
              answer:
                "Phoenix Wright: Ace Attorney Trials and Tribulations - Questioning ~ Moderato 2004",
            },
  
            {
              url: "https://soundcloud.com/user-338850232/dick-gumshoe-detective-gumshoe?in=user-338850232/sets/phoenix-wright-ace-attorney-ost",
              answer:
                "Phoenix Wright: Ace Attorney - Dick Gumshoe ~ Detective Gumshoe, Pal",
            },
            {
              url: "https://soundcloud.com/user-338850232/happy-people?in=user-338850232/sets/phoenix-wright-ace-attorney-ost",
              answer: "Phoenix Wright: Ace Attorney - Happy People",
            },
            {
              ...
              answer: "Phoenix Wright: Justice for All - Trick And Magic",
            },
            {
              url: "https://soundcloud.com/user-338850232/recollection-the-scenery-seen",
              answer:
                "Phoenix Wright: Ace Attorney Trials and Tribulations - Reminiscence ~ The Scenery Seen From Dusky Bridge",
            },
            {
            ...
            },
            {
              ...
              answer: "Phoenix Wright: Ace Attorney - The Steel Samurai",
            },
            {
              url: "https://soundcloud.com/everything_ace_attorney/ace-attorney-investigations-33?in=everything_ace_attorney/sets/ace-attorney-investigations",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Confrontation ~ Moderato 2009",
            },
            {
              url: "https://soundcloud.com/user-583594756/apollo-justice-a-new-trial-is?in=user-583594756/sets/apollo-justice-ace-attorney-ost",
              answer:
                "Apollo Justice: Ace Attorney - Apollo Justice ~ A New Trial Is In Session! (Objection 2007)",
            },
            {
              ...
              answer: "Phoenix Wright: Justice for All - Hotline Of Fate  ",
            },
            {
              url: "https://soundcloud.com/user-583594756/thrill-theme-suspense?in=user-583594756/sets/apollo-justice-ace-attorney-ost",
              answer: "Apollo Justice: Ace Attorney - Thrill Theme - Suspense",
            },
            {
              url: "https://soundcloud.com/everything_ace_attorney/ace-attorney-investigations-13?in=everything_ace_attorney/sets/ace-attorney-investigations",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Reminiscence ~ KG-8 Case",
            },
            ...
            {
              url: "https://soundcloud.com/user-338850232/shelly-de-killer-a-murderous?in=user-338850232/sets/phoenix-wright-ace-attorney-justice-for-all-ost",
              answer:
                "Phoenix Wright: Justice for All - Shelly De Killer ~ A Murderous Gentlemans Pleasure",
            },
            {
              url: "https://soundcloud.com/user-338850232/telling-the-truth-2001?in=user-338850232/sets/phoenix-wright-ace-attorney-ost",
              answer: "Phoenix Wright: Ace Attorney - Telling The Truth 2001",
            },
            {
              url: "https://soundcloud.com/user-583594756/investigation-opening-2007?in=user-583594756/sets/apollo-justice-ace-attorney-ost",
              answer:
                "Apollo Justice: Ace Attorney - Investigation ~ Opening 2007",
            },
            {
              url: "https://soundcloud.com/everything_ace_attorney/ace-attorney-investigations-10?in=everything_ace_attorney/sets/ace-attorney-investigations",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Shi-Long Lang ~ Speak Up, Pup!",
            },
            ...
            {
              url: "https://soundcloud.com/everything_ace_attorney/ace-attorney-investigations-25?in=everything_ace_attorney/sets/ace-attorney-investigations",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Investigation ~ Middlegame 2009",
            },
            {
              url: "https://soundcloud.com/user-583594756/cross-examination-allegro?in=user-583594756/sets/apollo-justice-ace-attorney-ost",
              answer:
                "Apollo Justice: Ace Attorney - Cross-Examination ~ Allegro",
            },
            {
              url: "https://soundcloud.com/user-583594756/drew-studio?in=user-583594756/sets/apollo-justice-ace-attorney-ost",
              answer: "Apollo Justice: Ace Attorney - Drew Studio",
            },
            {
              url: "https://soundcloud.com/user-583594756/ema-skye-the-scientific?in=user-583594756/sets/apollo-justice-ace-attorney-ost",
              answer:
                "Apollo Justice: Ace Attorney - Ema Skye ~ The Scientific Detective",
            },
  
            {
              url: "https://soundcloud.com/user-583594756/prologue?in=user-583594756/sets/apollo-justice-ace-attorney-ost",
              answer: "Apollo Justice: Ace Attorney - Prologue",
            },
  
            {
              url: "https://soundcloud.com/user-583594756/lamiroir-landscape-painter-in?in=user-583594756/sets/apollo-justice-ace-attorney-ost",
              answer:
                "Apollo Justice: Ace Attorney - Lamiroir ~ Landscape Painter In Sound",
            },
            {
              url: "https://soundcloud.com/user-583594756/trucys-theme-child-of-magic?in=user-583594756/sets/apollo-justice-ace-attorney-ost",
              answer:
                "Apollo Justice: Ace Attorney - Trucy's Theme ~ Child Of Magic",
            },
            {
              url: "https://soundcloud.com/user-583594756/investigation-core-2007?in=user-583594756/sets/apollo-justice-ace-attorney-ost",
              answer: "Apollo Justice: Ace Attorney - Investigation ~ Core 2007",
            },
            {
              url: "https://soundcloud.com/user-583594756/court-begins?in=user-583594756/sets/apollo-justice-ace-attorney-ost",
              answer: "Apollo Justice: Ace Attorney - Court Begins",
            },
  
            {
              url: "https://soundcloud.com/everything_ace_attorney/ace-attorney-investigations-31?in=everything_ace_attorney/sets/ace-attorney-investigations",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Court Guardians Of The Law",
            },
            {
              url: "https://soundcloud.com/everything_ace_attorney/ace-attorney-investigations-30?in=everything_ace_attorney/sets/ace-attorney-investigations",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Crises Of Fate",
            },
  
            {
              url: "https://soundcloud.com/everything_ace_attorney/ace-attorney-investigations-20?in=everything_ace_attorney/sets/ace-attorney-investigations",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Miles Edgeworth ~ Objection! 2009",
            },
            {
              url: "https://soundcloud.com/everything_ace_attorney/ace-attorney-investigations-15?in=everything_ace_attorney/sets/ace-attorney-investigations",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Quercus Alba ~ The Enemy Who Surpasses The Law",
            },
  
            {
              url: "https://soundcloud.com/everything_ace_attorney/ace-attorney-investigations-5?in=everything_ace_attorney/sets/ace-attorney-investigations",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Tricks And Gimmicks",
            },
            {
              url: "https://soundcloud.com/everything_ace_attorney/ace-attorney-investigations-14?in=everything_ace_attorney/sets/ace-attorney-investigations",
              answer:
                "Miles Edgeworth: Ace Attorney Investigations - Reminiscence ~ False Relations",
            },
  
            {
              url: "https://soundcloud.com/user-308844814/bonds-a-heart-that-believes?in=user-308844814/sets/ace-attorney-investigations-2-ost",
              answer: "Gyakuten Kenji 2 - Bonds ~ A Heart That Believes",
            },
            {
              url: "https://soundcloud.com/user-308844814/confess-the-truth-2011?in=user-308844814/sets/ace-attorney-investigations-2-ost",
              answer: "Gyakuten Kenji 2 - Confess the Truth ~ 2011",
            },
            {
              url: "https://soundcloud.com/user-308844814/confrontation-allegro-2011?in=user-308844814/sets/ace-attorney-investigations-2-ost",
              answer: "Gyakuten Kenji 2 - Confrontation ~ Allegro 2011",
            },
            {
              url: "https://soundcloud.com/user-308844814/confrontation-presto-2011?in=user-308844814/sets/ace-attorney-investigations-2-ost",
              answer: "Gyakuten Kenji 2 - Confrontation ~ Presto 2011",
            },
            {
              url: "https://soundcloud.com/user-308844814/hakari-mikagami-goddess-of-law?in=user-308844814/sets/ace-attorney-investigations-2-ost",
              answer: "Gyakuten Kenji 2 - Justine Courtney ~ Goddess of Law",
            },
            {
              url: "https://soundcloud.com/user-308844814/investigation-opening-2011?in=user-308844814/sets/ace-attorney-investigations-2-ost",
              answer: "Gyakuten Kenji 2 - Investigation ~ Opening 2011",
            },
            {
              url: "https://soundcloud.com/user-308844814/logic-chess-opening?in=user-308844814/sets/ace-attorney-investigations-2-ost",
              answer: "Gyakuten Kenji 2 - Logic Chess ~ Opening",
            },
  
            {
              url: "https://soundcloud.com/user-308844814/reiji-mitsurugi-objection-2011?in=user-308844814/sets/ace-attorney-investigations-2-ost",
              answer: "Gyakuten Kenji 2 - Objection! 2011",
            },
            {
              url: "https://soundcloud.com/user-308844814/reminiscence-is-7-incident?in=user-308844814/sets/ace-attorney-investigations-2-ost",
              answer: "Gyakuten Kenji 2 - Reminiscence ~ IS-7 Incident",
            },
            {
              url: "https://soundcloud.com/user-308844814/reminiscence-the-fall-of-the?in=user-308844814/sets/ace-attorney-investigations-2-ost",
              answer:
                "Gyakuten Kenji 2 - Reminiscence ~ The Fall of the House of Lang",
            },
  
            {
              url: "https://soundcloud.com/emilygwt/athena-cykes-lets-do-this?in=madeline-vanslyke/sets/dual-destinies-ost",
              answer:
                "Phoenix Wright: Dual Destinies - Athena Cykes - Let's Do This!",
            },
            {
              url: "https://soundcloud.com/emilygwt/apollo-justice-start-of-a?in=madeline-vanslyke/sets/dual-destinies-ost",
              answer:
                "Phoenix Wright: Dual Destinies - Apollo Justice - Start of a New Trial 2013",
            },
            {
              url: "https://soundcloud.com/emilygwt/difficult-people?in=madeline-vanslyke/sets/dual-destinies-ost",
              answer: "Phoenix Wright: Dual Destinies - Difficult People",
            },
            {
              url: "https://soundcloud.com/emilygwt/athena-cykes-courtroom-r?in=madeline-vanslyke/sets/dual-destinies-ost",
              answer:
                "Phoenix Wright: Dual Destinies - Athena Cykes - Courtroom Révolutionnaire",
            },
            {
              url: "https://soundcloud.com/emilygwt/pearl-fey-with-pearly-2013?in=madeline-vanslyke/sets/dual-destinies-ost",
              answer:
                "Phoenix Wright: Dual Destinies - Pearl Fey - With Pearly 2013",
            },
            {
              url: "https://soundcloud.com/emilygwt/won-the-case-everyones-victory?in=madeline-vanslyke/sets/dual-destinies-ost",
              answer:
                "Phoenix Wright: Dual Destinies - Won the Case! - Everyone's Victory",
            },
            {
              url: "https://soundcloud.com/emilygwt/phoenix-wright-objection-2013?in=madeline-vanslyke/sets/dual-destinies-ost",
              answer:
                "Phoenix Wright: Dual Destinies - Phoenix Wright ~ Objection! 2013",
            },
            {
              url: "https://soundcloud.com/emilygwt/courtroom-lounge-prelude-of?in=madeline-vanslyke/sets/dual-destinies-ost",
              answer:
                "Phoenix Wright: Dual Destinies - Courtroom Lounge ~ Prelude of Tomorrow",
            },
            {
              url: "https://soundcloud.com/jorgecabrera-1/simon-blackquill-twisted?in=madeline-vanslyke/sets/dual-destinies-ost",
              answer:
                "Phoenix Wright: Dual Destinies - Simon Blackquill ~ Twisted Swordsmanship",
            },
            {
              url: "https://soundcloud.com/bob-wilson-20/14-the-dark-age-of-law-1?in=madeline-vanslyke/sets/dual-destinies-ost",
              answer: "Phoenix Wright: Dual Destinies - The Dark Age Of Law",
            },
            {
              url: "https://soundcloud.com/valentin-cyprien/phoenix-wright-ace-attorney-soundtrack-dual-destinies-pursuit-keep-pressing-on?in=madeline-vanslyke/sets/dual-destinies-ost",
              answer:
                "Phoenix Wright: Dual Destinies - Pursuit ~ Keep Pressing On!",
            },
            {
              url: "https://soundcloud.com/itsamesmb/miles-edgeworth-great-revival?in=user-411498138/sets/ace-attorney-dual-destinies",
              answer:
                "Phoenix Wright: Dual Destinies - Miles Edgeworth ~ Great Revival 2013",
            },
            {
              url: "https://soundcloud.com/smiley-man-4/dual-destinies-ost-1-12?in=user-411498138/sets/ace-attorney-dual-destinies",
              answer:
                "Phoenix Wright: Dual Destinies - Announce the Truth ~ 2013",
            },
      ...
      return {
        c() {
          (t = w("meta")),
            ...
            (C = x()),
            H && H.c(),
            (An.title = "Ace Attorney Heardle"),
            M(t, "name", "description"),
            M(
              t,
              "content",
              "Guess the Ace Attorney song from the intro in as few tries as possible! "
            ),
